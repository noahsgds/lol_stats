    ...
    return (
        <>
            <div className="history">
                ...
                {remaining > 0 && (
                    <button className="mh-show-more" onClick={() => setShown(s => s + DEFAULT_SHOWN)}>
                        Voir plus · {remaining} partie{remaining > 1 ? 's' : ''} restante{remaining > 1 ? 's' : ''}
                    </button>
                )}
                {shown > DEFAULT_SHOWN && (
                    <button className="mh-show-more mh-show-less" onClick={() => setShown(DEFAULT_SHOWN)}>
                        Réduire ▲
                    </button>
                )}
            </div>
